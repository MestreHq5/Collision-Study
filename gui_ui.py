...
"                                                        }")
        ...
        self.genLog = QPlainTextEdit(self.Page_5)
        self.genLog.setObjectName(u"genLog")
        self.genLog.setVisible(False)
        self.genLog.setMaximumSize(QSize(16777215, 110))
        self.genLog.setReadOnly(True)
        font = QFont()
        font.setFamilies([u"Consolas"])
        font.setPointSize(9)
        self.genLog.setFont(font)

        self.verticalLayout_6.addWidget(self.genLog)
